...
def users():
    ...
    # Convert users dict to a list of dicts for easy sorting/display
    users_list = [v for k, v in sorted(users_dict.items(), key=lambda x: x[1].get("timestamp", ""))]
...
def index():
    return (
        ...
        "/api/user_count (GET: total registered users)<br>"
